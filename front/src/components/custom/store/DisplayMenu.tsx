          ...
          <Card className="cursor-pointer w-54 h-59 border-1" key={menu.id} onClick={() => handleAddToCart(menu.id, menu.name, menu.base_price, menu.discount_price)}>
            <CardHeader>
                <div className="w-30 h-30 bg-blue-500 rounded-2xl mx-auto">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f6/Eataly_Las_Vegas_-_Feb_2019_-_Sarah_Stierch_12.jpg/500px-Eataly_Las_Vegas_-_Feb_2019_-_Sarah_Stierch_12.jpg" className="w-full h-full rounded-xl"></img>
                </div>
            </CardHeader>
            <CardContent>
