export default function DisplayStoreItem({name, img_src, star, avg_time, description} : {name : string, img_src? : string, star : number, avg_time : number[], description : string}){
    return(
