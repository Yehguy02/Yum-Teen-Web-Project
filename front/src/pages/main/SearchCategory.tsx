    ...
    useEffect(() => {
        const fetchSearch = async () => {
            try {
                ...
                const data = await storeAPI.searchByCategory(keyword);
            ...
            <div className="bg-gray-200 min-h-screen">
                ...
                <div className="pl-25 pt-5">
                    {isLoading ? (
                        ...
                        <div>No stores found in "{keyword}" category</div>
                    ) : (
                        <DisplayStore title={`Stores in "${keyword}" Category`} stores_list={stores}/>
                    )}
                </div>
